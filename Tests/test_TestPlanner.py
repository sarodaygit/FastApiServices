...
project_dir = os.path.abspath(os.path.join(current_dir, '..', 'Sources/FastApiServices'))
sys.path.append(project_dir)

from fastapi.testclient import TestClient
from Sources.FastApiServices.main import app
from Sources.FastApiServices.Routers.TestPlannerRouter import TestPlannerRouter
